<script lang="ts">
  ...
  function getDirtyAirPath(boatX: number, boatY: number, boatRotation: number, windDir: number): string {
    ...
    const endX1 = boatX + DIRTY_AIR_LENGTH * Math.sin((endAngle1 * Math.PI) / 180) + (DIRTY_AIR_WIDTH_END / 2) * Math.sin((endAngle1 * Math.PI) / 180);
    const endY1 = boatY - DIRTY_AIR_LENGTH * Math.cos((endAngle1 * Math.PI) / 180) + (DIRTY_AIR_WIDTH_END / 2) * Math.cos((endAngle1 * Math.PI) / 180);
    const endX2 = boatX + DIRTY_AIR_LENGTH * Math.sin((endAngle2 * Math.PI) / 180) + (DIRTY_AIR_WIDTH_END / 2) * Math.sin((endAngle2 * Math.PI) / 180);
    const endY2 = boatY - DIRTY_AIR_LENGTH * Math.cos((endAngle2 * Math.PI) / 180) + (DIRTY_AIR_WIDTH_END / 2) * Math.cos((endAngle2 * Math.PI) / 180);
  ...
  function getWindwardDirtyAirPath(boatX: number, boatY: number, boatRotation: number, windDir: number): string {
    ...
    const endX1 = boatX - WINDWARD_LENGTH * Math.sin((startAngle1 * Math.PI) / 180) + (WINDWARD_WIDTH_END / 2) * Math.sin((startAngle1 * Math.PI) / 180);
    const endY1 = boatY + WINDWARD_LENGTH * Math.cos((startAngle1 * Math.PI) / 180) + (WINDWARD_WIDTH_END / 2) * Math.cos((startAngle1 * Math.PI) / 180);
    const endX2 = boatX - WINDWARD_LENGTH * Math.sin((startAngle2 * Math.PI) / 180) + (WINDWARD_WIDTH_END / 2) * Math.sin((startAngle2 * Math.PI) / 180);
    const endY2 = boatY + WINDWARD_LENGTH * Math.cos((startAngle2 * Math.PI) / 180) + (WINDWARD_WIDTH_END / 2) * Math.cos((startAngle2 * Math.PI) / 180);
