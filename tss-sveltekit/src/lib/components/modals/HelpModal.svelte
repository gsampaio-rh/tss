      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 0.5rem; vertical-align: middle;">
        ...
        <div class="modal-body">
          <div class="help-content">
            ...
            <section class="help-section mb-4">
              ...
              <p>
                The Tactical Sailing Simulator (TSS) helps you understand and practice sailing tactics, 
                especially how wind shifts affect boat performance and positioning.
              </p>
              <ol>
                <li><strong>Start Phase:</strong> Add players, position boats on the start line (drag to move), and select a wind scenario.</li>
                <li><strong>Race Phase:</strong> Each turn, select actions for each boat (Forward, Tack, or To Mark).</li>
                <li><strong>Analysis:</strong> Use the tactical cards and insights panel to understand boat performance.</li>
              </ol>
            </section>
            ...
            <section class="help-section mb-4">
              ...
              <ul>
                ...
                <li><strong>Boat Actions:</strong>
                  <ul>
                    <li><strong>Forward:</strong> Continue on current tack</li>
                    <li><strong>Tack:</strong> Change tack (port ↔ starboard)</li>
            ...
            <section class="help-section mb-4">
              ...
              <div class="tactical-concepts">
                <div class="concept-item mb-3">
                  ...
                  <ul>
                    <li><strong>Lift:</strong> Wind shift that allows you to sail closer to the mark (favorable)</li>
                    <li><strong>Header:</strong> Wind shift that forces you away from the mark (unfavorable)</li>
                  </ul>
                </div>
                <div class="concept-item mb-3">
                ...
                <div class="concept-item mb-3">
                  ...
                  <p class="mb-1">Visual indicators showing different sailing angles relative to wind (dead zone, close hauled, beam reach, etc.)</p>
                </div>
              </div>
            </section>
            ...
            <section class="help-section mb-4">
              ...
              <ul>
                <li><strong>Wind Particles:</strong> Teardrop shapes showing wind direction and flow</li>
                <li><strong>Boat Tracks:</strong> Trails showing where each boat has sailed</li>
                <li><strong>Laylines:</strong> Lines showing optimal approach angles to the mark</li>
                <li><strong>Wind Zones:</strong> Colored arcs showing different sailing angles (enable in settings)</li>
                <li><strong>Dirty Air Zones:</strong> Visual representation of turbulent air behind boats (enable in settings)</li>
            ...
            <section class="help-section mb-4">
              ...
              <ul>
                ...
                <li><strong>Dirty Air Effects:</strong> Enable/disable speed penalties from dirty air</li>
              </ul>
            </section>
