...
**Version 1.4.0** - Major component refactoring milestone, improved code organization and maintainability.
...
- [Wind Mechanics Spec](./docs/WIND_MECHANICS_SPEC.md) - Complete wind mechanics specification (if available)
- [Wind Dynamics](./docs/WIND_DYNAMICS.md) - Wind mechanics explanation (if available)
...
**1.4.0** - Major component refactoring milestone, improved code organization and maintainability.
